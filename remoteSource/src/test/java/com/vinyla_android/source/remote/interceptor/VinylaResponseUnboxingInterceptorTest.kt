...
internal class VinylaResponseUnboxingInterceptorTest {
    ...
    private lateinit var interceptor: com.vinyla_android.source.remote.VinylaResponseUnboxingInterceptor

    @BeforeEach
    fun setUp() {
        chain = mockk(relaxed = true)
        interceptor = com.vinyla_android.source.remote.VinylaResponseUnboxingInterceptor()
    }
